...
var app = (function () {
    ...
    const regSchema = create().shape({
    	...
    	email: create$1().required("(Bitte geben Sie Ihre E-Mail Adresse ein)").email("(Die angebene E-Mail Adresse hat ein ungültiges Format)"),
    	msg: create$1().required("(Bitte geben Sie eine Nachricht ein.)"),
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "class", "svelte-1f4vtaq");
    			add_location(path0, file, 105, 4, 3005);
    			...
    			attr_dev(path1, "class", "svelte-1f4vtaq");
    			add_location(path1, file, 109, 4, 3710);
    			attr_dev(svg, "class", "success-checkmark svelte-1f4vtaq");
    			attr_dev(svg, "width", "257");
    			attr_dev(svg, "height", "257");
    			attr_dev(svg, "viewBox", "0 0 257 257");
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file, 104, 3, 2875);
    			attr_dev(p, "class", "success-message svelte-1f4vtaq");
    			add_location(p, file, 114, 3, 5183);
    			attr_dev(div, "class", "success svelte-1f4vtaq");
    			add_location(div, file, 103, 2, 2850);
    		},
    ...
    // (68:1) {#if !formSuccessfullySubmitted}
    function create_if_block(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*errors*/ ctx[1].firstname && create_if_block_5(ctx);
    	let if_block1 = /*errors*/ ctx[1].lastname && create_if_block_4(ctx);
    	let if_block2 = /*errors*/ ctx[1].email && create_if_block_3(ctx);
    	let if_block3 = /*errors*/ ctx[1].msg && create_if_block_2(ctx);
    	let if_block4 = /*errors*/ ctx[1].agreed && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-1f4vtaq");
    			add_location(textarea, file, 82, 4, 2128);
    			attr_dev(div0, "class", "textarea svelte-1f4vtaq");
    			add_location(div0, file, 81, 3, 2101);
    			attr_dev(input3, "class", "checkbox svelte-1f4vtaq");
    			attr_dev(input3, "type", "checkbox");
    			set_style(input3, "cursor", "pointer");
    			attr_dev(input3, "name", "checkbox");
    			add_location(input3, file, 88, 4, 2333);
    			attr_dev(a, "href", "/datenschutz");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "class", "svelte-1f4vtaq");
    			add_location(a, file, 91, 5, 2486);
    			attr_dev(label, "for", "checkbox");
    			attr_dev(label, "class", "svelte-1f4vtaq");
    			add_location(label, file, 89, 4, 2449);
    			attr_dev(div1, "class", "email-form-checkboxes svelte-1f4vtaq");
    			set_style(div1, "cursor", "pointer");
    			add_location(div1, file, 87, 3, 2269);
    			attr_dev(button, "class", "btn outline svelte-1f4vtaq");
    			add_location(button, file, 99, 4, 2731);
    			attr_dev(div2, "class", "email-form-button svelte-1f4vtaq");
    			add_location(div2, file, 98, 3, 2695);
    			attr_dev(form, "class", "email svelte-1f4vtaq");
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea, /*fields*/ ctx[0].msg);
    			append_dev(form, t6);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", prevent_default(/*handleSubmit2*/ ctx[3]), false, true, false),
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(68:1) {#if !formSuccessfullySubmitted}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "error svelte-1f4vtaq");
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(71:3) {#if errors.firstname}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(75:3) {#if errors.lastname}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*errors*/ 2 && t_value !== (t_value = /*errors*/ ctx[1].msg + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "wrapper-contactform svelte-1f4vtaq");
    ...
    const app = new App({
    	target: document.querySelector("#contactform-hook"),
    });
