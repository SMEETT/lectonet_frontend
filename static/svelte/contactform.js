    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br = element("br");
    			attr_dev(br, "class", "svelte-8l16f2");
    			add_location(br, file, 103, 55, 2906);
    			attr_dev(div, "class", "success svelte-8l16f2");
    			add_location(div, file, 102, 2, 2829);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-8l16f2");
    			add_location(textarea, file, 81, 3, 2101);
    			attr_dev(input3, "class", "checkbox svelte-8l16f2");
    			attr_dev(input3, "type", "checkbox");
    			set_style(input3, "cursor", "pointer");
    			attr_dev(input3, "name", "checkbox");
    			add_location(input3, file, 87, 4, 2312);
    			attr_dev(a, "href", "/datenschutz");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "class", "svelte-8l16f2");
    			add_location(a, file, 90, 5, 2465);
    			attr_dev(label, "for", "checkbox");
    			attr_dev(label, "class", "svelte-8l16f2");
    			add_location(label, file, 88, 4, 2428);
    			attr_dev(div0, "class", "email-form-checkboxes svelte-8l16f2");
    			set_style(div0, "cursor", "pointer");
    			add_location(div0, file, 86, 3, 2248);
    			attr_dev(button, "class", "btn outline svelte-8l16f2");
    			add_location(button, file, 98, 4, 2710);
    			attr_dev(div1, "class", "email-form-button svelte-8l16f2");
    			add_location(div1, file, 97, 3, 2674);
    			attr_dev(form, "class", "email svelte-8l16f2");
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "error svelte-8l16f2");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "wrapper-contactform svelte-8l16f2");
