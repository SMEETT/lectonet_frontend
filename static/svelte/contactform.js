    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "class", "svelte-1t6l5la");
    			...
    			attr_dev(path1, "class", "svelte-1t6l5la");
    			add_location(path1, file, 107, 4, 3673);
    			attr_dev(svg, "class", "success-checkmark svelte-1t6l5la");
    			...
    			attr_dev(p, "class", "success-message svelte-1t6l5la");
    			add_location(p, file, 112, 3, 5146);
    			attr_dev(div, "class", "success svelte-1t6l5la");
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-1t6l5la");
    			add_location(textarea, file, 81, 3, 2101);
    			attr_dev(input3, "class", "checkbox svelte-1t6l5la");
    			...
    			attr_dev(a, "class", "svelte-1t6l5la");
    			add_location(a, file, 89, 5, 2449);
    			attr_dev(label, "for", "checkbox");
    			attr_dev(label, "class", "svelte-1t6l5la");
    			add_location(label, file, 87, 4, 2412);
    			attr_dev(div0, "class", "email-form-checkboxes svelte-1t6l5la");
    			set_style(div0, "cursor", "pointer");
    			add_location(div0, file, 85, 3, 2232);
    			attr_dev(button, "class", "btn outline svelte-1t6l5la");
    			add_location(button, file, 97, 4, 2694);
    			attr_dev(div1, "class", "email-form-button svelte-1t6l5la");
    			add_location(div1, file, 96, 3, 2658);
    			attr_dev(form, "class", "email svelte-1t6l5la");
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "error svelte-1t6l5la");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "wrapper-contactform svelte-1t6l5la");
